...
namespace Programa_controles
{
    public partial class Form1 : Form
    {
        ...
        {
            string consulta = "select Codigo, Fecha, Oc, Descripcion, Controlo, Cdmaterial, Tdlote, Tdaql, Estado, Observaciones from control04";
        ...
        private void AgregarRegistro()
        {
            ...
            {
                conexion.Open();
                string consulta = "insert into control04 (Controlo, Fecha, Estado, Tdaql, Oc, Tdlote, Descripcion, Cdmaterial, Observaciones) values (@Controlo, @Fecha, @Estado, @Tdaql, @Oc, @Tdlote, @Descripcion, @Cdmaterial, @Observaciones)";
        ...
        private void EliminarRegistro()
        {
            ...
            {
                conexion.Open();
                string consulta = "delete from control04 where Codigo = @Codigo";
                SqlCommand comando = new SqlCommand(consulta, conexion);
        ...
        private void ModificarRegistro()
        {
            ...
            {
                conexion.Open();
                string consulta = "update control04 set Controlo = @Controlo, Fecha = @Fecha, Estado = @Estado, Tdaql = @Tdaql, Oc = @Oc, Tdlote = @Tdlote, Descripcion = @Descripcion, Cdmaterial = @Cdmaterial, Observaciones = @Observaciones where Codigo = @Codigo";
                SqlCommand comando = new SqlCommand(consulta, conexion);
                comando.Parameters.AddWithValue("@Controlo", textBox2.Text);
                comando.Parameters.AddWithValue("@Fecha", textBox3.Text);
                comando.Parameters.AddWithValue("@Estado", textBox4.Text);
        ...
        private void RealizarBusqueda()
        {
            ...
            string consulta = string.Format("SELECT Codigo, Fecha, Oc, Descripcion, Controlo, Cdmaterial, Tdlote, Tdaql, Estado, Observaciones FROM control04 WHERE {0} LIKE '%{1}%'", columnaBusqueda, parametroBusqueda);
